...
import com.adiluhung.storyapp.data.local.room.RemoteKeys
...
class StoryRemoteMediator(
    ...
    override suspend fun load(loadType: LoadType, state: PagingState<Int, StoryItem>): MediatorResult {
        ...
        try {
            val responseData = apiService.getStories("Bearer $userToken", page, state.config.pageSize)
            ...
            database.withTransaction {
                ...
                database.storiesDao().insertStories(listStory)
            }
